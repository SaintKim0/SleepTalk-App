...
// GPT API 호출 함수
export const generateGPTResponse = async (message, conversationHistory = []) => {
  try {
...
const getFallbackResponse = (message) => {
  ...
  } else if (lowerMessage.includes('스트레스') || lowerMessage.includes('불안')) {
...
export const gptAIInfo = {
  title: 'GPT AI 시스템',
  description: 'OpenAI의 GPT 모델을 사용한 고급 AI 채팅 시스템입니다.',
  features: [
    '✅ 가장 자연스러운 대화',
    '✅ 맥락 이해',
    '✅ 창의적인 응답',
  ...
  setupGuide: {
    ...
    costs: {
      gpt35: 'GPT-3.5: 약 $0.002/1K 토큰',
      gpt4: 'GPT-4: 약 $0.03/1K 토큰',
      note: '일반적인 대화 1회당 약 $0.01-0.05'
    }
  }
}; 